...
const Zero = () => {
    return (
        <>
            <div className=' font-heading p-10 lg:mx-20 px-4 mt-6 lg:mt-20 pb-20'>
                <div className='flex flex-col gap-5 pr-5 items-center'>
                    ...
                    <div className='flex flex-col gap-5 items-center'>
                        <div className='flex items-start gap-1 font-bold lg:text-5xl text-lg gap-2'>
                ...
                <div className='lg:flex hidden w-full gap-5 pt-10'>
                ...
                <div className='flex justify-center relative '>
                    ...
                    <div className='shadow-[0_0_80px_#A6FF00]
                     absolute z-2 lg:mt-30 mt-18 pl-2.5 pr-2  py-2 rounded-full bg-neon-green flex justify-center align-middle items-center'>
